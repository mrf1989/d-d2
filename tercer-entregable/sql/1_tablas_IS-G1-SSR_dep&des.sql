...
CREATE TABLE INSCRIPCIONES (
    ...
    FOREIGN KEY (OID_Part) REFERENCES PARTICIPANTES ON DELETE CASCADE,
    FOREIGN KEY (OID_Act) REFERENCES ACTIVIDADES ON DELETE CASCADE,
    FOREIGN KEY (OID_Rec) REFERENCES RECIBOS ON DELETE CASCADE
);
...
CREATE TABLE PATROCINIOS (
    ...
    OID_Act INTEGER NOT NULL,
    FOREIGN KEY (cif) REFERENCES INSTITUCIONES ON DELETE CASCADE,
    FOREIGN KEY (OID_Act) REFERENCES ACTIVIDADES ON DELETE CASCADE
);
...
CREATE TABLE DONACIONES (
    ...
    FOREIGN KEY (cif) REFERENCES INSTITUCIONES ON DELETE CASCADE,
    FOREIGN KEY (dni) REFERENCES PERSONAS ON DELETE CASCADE,
    FOREIGN KEY (OID_TDon) REFERENCES TIPODONACIONES ON DELETE CASCADE
);
...
CREATE TABLE ENVIOS (
    ...
    dni CHAR(9),
    cif CHAR(9),
    FOREIGN KEY (OID_M) REFERENCES MENSAJES ON DELETE CASCADE,
    FOREIGN KEY (dni) REFERENCES PERSONAS ON DELETE CASCADE,
    FOREIGN KEY (cif) REFERENCES INSTITUCIONES ON DELETE CASCADE
);
...
CREATE TABLE FORMULARIOS (
    ...
    FOREIGN KEY (OID_Q) REFERENCES PREGUNTAS ON DELETE CASCADE
);
